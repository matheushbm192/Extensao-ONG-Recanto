...
function atualizarInterfaceUsuario() {
    ...
    if (user) {
        ...
        if (cadastrarUsuarioComum)
            cadastrarUsuarioComum.style.display = "none";
        const isAdmin = user.tipo_usuario === "admin";
        if (cadastroAnimal)
            cadastroAnimal.style.display = isAdmin ? "inline" : "none";
        if (cadastroAdmnistrador)
            cadastroAdmnistrador.style.display = isAdmin ? "inline" : "none";
        if (cadastrarUsuarioVoluntario)
            cadastrarUsuarioVoluntario.style.display = isAdmin ? "inline" : "none";
    }
    else {
        if (loginMenu)
        ...
        if (cadastrarUsuarioComum)
            cadastrarUsuarioComum.style.display = "inline";
        if (cadastroAnimal)
            cadastroAnimal.style.display = "none";
        if (cadastroAdmnistrador)
            cadastroAdmnistrador.style.display = "none";
        if (cadastrarUsuarioVoluntario)
            cadastrarUsuarioVoluntario.style.display = "none";
    }
}
