...
const animalList = document.getElementById("animal-list") as HTMLUListElement;
...
const filtroRaca = document.getElementById("filtro-raca") as HTMLSelectElement;
const filtroSexo = document.getElementById("filtro-sexo") as HTMLSelectElement;
const filtroIdade = document.getElementById("filtro-idade") as HTMLSelectElement;

function getFilteredAnimals(): Animal[] {
